...
public class CashSessionToCashSessionListObjectMapping : Profile
{
    public CashSessionToCashSessionListObjectMapping()
    {
        CreateMap<CashSession, CashSessionListObject>()
